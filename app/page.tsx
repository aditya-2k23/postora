      ...
      <main className="my-auto max-w-5xl w-full z-10 flex flex-col items-center text-center space-y-12 py-20">
        <div className="space-y-6">
          ...
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-gray-900 dark:text-gray-100">
            Create Engaging Social Content <br className="hidden md:block" /> in
            Seconds.
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Social Media Studio turns a simple idea into ready-to-publish posts,
            carousels, and stories with AI-generated copy and visuals.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          <Link href="/studio">
            <Button
              size="lg"
              className="h-14 px-8 text-lg rounded-full bg-blue-600 hover:bg-blue-700 shadow-lg hover:shadow-blue-500/25 transition-all"
            >
          ...
          <Link href="/login">
            <Button
              size="lg"
              variant="outline"
              className="h-14 px-8 text-lg rounded-full bg-white dark:bg-zinc-900 border-gray-200 dark:border-zinc-800"
            >
              Sign In
            </Button>
          </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl mt-16 text-left">
          <div className="p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 shadow-sm">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Instantly format for Instagram, LinkedIn, X, and TikTok with
          ...
          <div className="p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 shadow-sm">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              AI automatically breaks down complex topics into engaging,
              swipeable slides.
            </p>
          </div>
          <div className="p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 shadow-sm">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Download high-quality PNGs or PDFs ready to be published to your
              audience.
            </p>
          </div>
        </div>
        ...
        <div className="w-full max-w-2xl mt-12 bg-white dark:bg-zinc-900 rounded-3xl p-8 border border-gray-100 dark:border-zinc-800 shadow-xl shadow-gray-200/50 dark:shadow-none text-left">
          ...
          <div className="space-y-3">
            {examplePrompts.map((p, i) => (
              <div
                key={i}
                className="p-4 rounded-xl bg-gray-50 dark:bg-zinc-950 text-gray-700 dark:text-gray-300 text-sm hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:text-blue-700 transition-colors cursor-pointer border border-transparent hover:border-blue-100 dark:hover:border-blue-900/50"
              >
                &quot;{p}&quot;
              </div>
            ))}
