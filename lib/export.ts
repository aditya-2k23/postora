...
import { JSZip } from 'jszip'; // Need JSZip to export multiple PNGs, or just download individually. Since I don't have JSZip, I'll download individually or just one long PDF.
...
export const exportToPDF = async () => {
    ...
    for (let i = 0; i < nodes.length; i++) {
        ...
        pdf.addImage(dataUrl, 'PNG', 0, 0, nodes[i].offsetWidth, nodes[i].offsetHeight);
    }
