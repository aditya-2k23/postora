...
export function CenterCanvas() {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-between p-4 md:p-8 overflow-hidden relative">
      ...
      <div className="flex-1 max-h-[70vh] flex justify-center items-center relative z-10 w-full overflow-hidden">
        ...
        <AnimatePresence mode="wait">
          {activeCard && (
            ...
            >
              <div
                className="relative w-full bg-white dark:bg-zinc-900 shadow-xl rounded-xl overflow-hidden border border-gray-200 dark:border-zinc-800"
                style={{
